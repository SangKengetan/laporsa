        ...
        <div class="container grid px-6 mx-auto">
            ...
            <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                    ...
                    @endif
                    <form action="{{ route('pengaduans.index') }}" method="GET" class="my-4 flex items-center">
                        @csrf
                        <input type="text" name="search_query" class="px-4 py-2 border rounded-l-md w-full"
                            placeholder="Search..." />
                        <button type="submit" class="px-4 py-2 bg-blue-500 text-white font-semibold rounded-r-md">
                            Search
                        </button>
                    </form>
